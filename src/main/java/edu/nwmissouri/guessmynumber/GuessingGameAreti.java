 ...
 */
public class GuessingGameAreti {

    public static void main(String[] args) {
        // TODO: change computerNumber to secretNumber Hint: Right-click / Refactor / Rename
        int laptopId = (int) (Math.random() * 100 + 1);
        int userAnswer = 0;
        System.out.println("The correct guess would be " + laptopId);
        int count = 1;

        while (userAnswer != laptopId) {
            ...
            String response = JOptionPane.showInputDialog(null,
                    message, "Guessing Game", 3);
            userAnswer = Integer.parseInt(response);

            JOptionPane.showMessageDialog(null, "" + displayMessage(userAnswer, laptopId, count));
            count++;
        }
    }

    // TODO: Refactor / Rename determineGuess to calculateMessage
    public static String displayMessage(int userAnswer, int computerNumber, int count) {
        ...
        String s = (count == 1) ? "guesses." : "guesses.";
